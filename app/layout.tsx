...
export const metadata: Metadata = {
  title: "Team Nexus — Web, Mobile & AI Development Agency | Indore, India",
  description: "Team Nexus builds production-grade websites, mobile apps, and AI systems for startups, local businesses, and SaaS founders. Hackathon champions. Delivering in weeks, not months.",
};
    ...
    <html lang="en" className={`${spaceGrotesk.variable} ${plusJakartaSans.variable} ${jetbrainsMono.variable}`}>
      <body>
        ...
        <SmoothScroll>
          ...
          {/* Interactive Connected Particles Background */}
          <CanvasBackground />
